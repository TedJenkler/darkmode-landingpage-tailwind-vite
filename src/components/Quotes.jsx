...
function Quotes() {
  return (
    <section className='mx-12 text-white font-display lg:flex lg:gap-10 lg:mx-40'>
        <img className='lg:h-4' src={quote} alt='quote'/>
        <div className='bg-lightbg py-6 px-5 rounded mb-6 lg:h-52'>
        ...
        <div className='bg-lightbg py-6 px-5 rounded lg:h-52'>
            <p className='q font-sans italic mb-4'>Fylo has improved our team productivity by an order of magnitude. Since making the switch our team has become a well-oiled collaboration machine.</p>
            <div className='flex items-center gap-2'>
