...
function LinkSection() {
  return (
    <section className='text-white font-display mx-6 flex flex-col items-center mb-40 lg:flex-row lg:justify-center lg:gap-14 lg:mx-24'>
        <img className='mb-12 lg:w-1/2' src={linkimg} alt='linkimg' />
