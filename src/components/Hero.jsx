...
function Hero() {
  return (
    <section className='bg-lightbg text-white text-center mb-32'>
        <div className='flex flex-col items-center  bg-bgcurve bg-no-repeat bg-cover md:bg-bgcurve-desktop lg:bg-bgcurve-desktop lg:bg-cover'>
        ...
        <div className='bg-bg px-10'>
            <p className='font-display mb-8 md:px-80'>Fylo stores all your most important files in one secure location. Access them wherever you need, share and collaborate with friends family, and co-workers.</p>
